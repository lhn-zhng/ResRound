...
RUN_TAG="joint_residual_r0p003_p2048_a1024_r0p50_qkv8_only_continuous_from0_20260725"
...
export MASTER_PORT="${MASTER_PORT:-6640}"
export WANDB_MODE="${WANDB_MODE:-online}"
export WANDB_PROJECT="${WANDB_PROJECT:-megatron_fp4_llama2_1p24b}"

# Cross-fit uses 2048 proposal tokens and 1024 disjoint audit tokens.  Weight
# rounding is restricted to QKV in zero-based transformer layers [0, 8).
...
joint_args=(
    ...
    --fp4-outlier-weight-rounding-proj-layer-end 0
