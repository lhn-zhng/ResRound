...
def _add_network_size_args(parser):
    ...
    transformer_group.add_argument(
        ...
        "--disable-fp4-outlier-enable-dgrad",
        action="store_false",
        dest="fp4_outlier_enable_dgrad",
        default=False,
        help=(
            "Compatibility alias. The clean FP4 input-outlier branch keeps custom DGRAD disabled."
        ),
    )
    transformer_group.add_argument(
        "--no-fp4-outlier-enable-wgrad",
        "--disable-fp4-outlier-enable-wgrad",
        action="store_false",
        dest="fp4_outlier_enable_wgrad",
        default=False,
        help=(
            "Compatibility alias. The clean FP4 input-outlier branch keeps custom WGRAD disabled."
        ),
    )
